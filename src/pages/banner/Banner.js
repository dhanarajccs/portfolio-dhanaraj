        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-5 gap-3">
          ...
          <div className="w-[300px] lg:w-full flex flex-col justify-center items-enter">
            <h1 className="lg:text-5xl text-secondary font-bold">             
              <Typewriter
                options={{
                  strings: ["I'm Dhanaraj Narasimmareddy!", "A Full Stack Web Developer"],
                  autoStart: true,
                  loop: true,
                }}
              />
            ...
            <p className="py-6 lg:text-lg text-sm text-center">
              Hi, I'm Dhanaraj, a skilled and enthusiastic React web developer
              with 5 years of experience. I am passionate about creating
